if(CPACK_PACKAGE_FILE_NAME MATCHES ".*-src$")
    message(FATAL_ERROR "Creating source archives for SDL 3.3.0 is not supported.")
endif()

set(PROJECT_SOURCE_DIR "/home/dani/Desktop/sdlProject/SDL")
...
set(CPACK_PACKAGE_FILE_NAME "SDL3-3.3.0-${SDL_CMAKE_PLATFORM}${SDL_CPU_NAMES_WITH_DASHES}")

if(CPACK_GENERATOR STREQUAL "DragNDrop")
    set(CPACK_DMG_VOLUME_NAME "SDL3 3.3.0")
